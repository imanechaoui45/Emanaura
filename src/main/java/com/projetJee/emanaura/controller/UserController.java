...
import com.projetJee.emanaura.model.*;
import com.projetJee.emanaura.service.CartService;
import com.projetJee.emanaura.service.CategoryService;
...
public class UserController {
	...
	public String addToCartAlternate(@PathVariable Integer pid, Principal p, HttpSession session) {
		if (p == null) {
